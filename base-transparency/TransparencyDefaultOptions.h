...
void installTransparencyOptions()
{
    ...
    // foreground
    XmlOptions::get().set( QStringLiteral("TRANSPARENCY_FOREGROUND_COLOR"), Base::Color( Qt::white ) );
    XmlOptions::get().set<int>( QStringLiteral("TRANSPARENCY_FOREGROUND_INTENSITY"), 255 );

    // shadow
    XmlOptions::get().set( QStringLiteral("TRANSPARENCY_SHADOW_COLOR"), Base::Color( Qt::black ) );
    ...
    // tint
    XmlOptions::get().set( QStringLiteral("TRANSPARENCY_TINT_COLOR"), Base::Color( Qt::white ) );
