...
namespace SVG
{
  static const QString helpText[] =
  {
    ...
    "<li><i>offset</i> is a possible offset to be added between the SVG file <i>border</i> and the widget true border. A positive offset means "
    "that the SVG background will be smaller than the widget true size. A negative value means that the SVG background is larger than the widget. "
    "This option is used notably to accommodate SVG files that have large empty (that is: transparent) borders on the sides.</li>"
    "</ul>"
